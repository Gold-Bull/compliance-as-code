...
description: |-
    ...
    Ubuntu 20.04 LTS Benchmark, v1.1.0, released 03-31-2021.
...
selections:
    ...
    ##### 3.5.3.2.4 Ensure iptables firewall rules exist for all open ports (Manual)
    # Skip due to being a manual test
    ...
    # 3.5.3.3.3 Ensure IPv6 default deny firewall policy (Automated)
